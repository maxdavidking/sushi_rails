...
ActiveRecord::Schema.define(version: 20_180_514_213_548) do
  ...
  create_table "validsushis", force: :cascade do |t|
    t.string "name"
    t.string "endpoint"
    t.string "cust_id"
    t.string "req_id"
